...
/*
•Description – This main function checks if the arguments given are valid, and sends the argv to "MainClient"
• Parameters –	argc- number of cells in the argv array, argv- location of an array containing the information: " <server ip> <server port> <username>"
